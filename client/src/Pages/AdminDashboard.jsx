  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        console.log("doramaon", res.data.users);
  ...
  useEffect(() => {
    const fetchRevenue = async () => {
      try {
        ...
        const revenueData =
          res.data.analytics.subscriptions.revenue;
        setRevenue({
      ...
      <div className="adminDash-main">
        ...
        <div className="adminDash-content bg-blue-50">
          ...
          <div className="HeroAdmin">
            ...
            <div className="HeroAdminCard flex justify-evenly shadow-xl">
              <span className='text-3xl flex flex-col gap-10.5 pt-1.5'><h2>Total Revenue</h2><p className='flex flex-col justify-center items-center text-4xl font-semibold'>{loadingRevenue ? "Loading..." : `Rs. ${revenue.total}`}</p></span>
            </div>

            <div className="HeroAdminCard flex justify-center shadow-xl">
              <span className='text-3xl flex flex-col gap-10.5 pt-1.5'><h2>Total Subscriptions</h2><p className='flex flex-col justify-center items-center text-4xl font-semibold'>{loading ? "Loading..." : totalSubscription}</p></span>
            </div>
            <div className="HeroAdminCard flex justify-center shadow-xl">
              <span className='text-3xl flex flex-col gap-10.5 pt-1.5'><h2>Total Users</h2><p className='flex flex-col justify-center items-center text-4xl font-semibold'>{loading ? "Loading..." : totalUsers}</p></span>
            </div>
            <div className="HeroAdminCard flex justify-center shadow-xl">
              <span className='text-3xl flex flex-col gap-10.5 pt-1.5'><h2>Growth Rate</h2><p className='flex flex-col justify-center items-center text-4xl font-semibold'>{loadingRevenue ? "Loading..." : `Rs. ${revenue.total}`}</p></span>
            </div>
          </div>
