    ...
    return (
        <div className="admin-anlytics-layout">
            ...
            <div className="admin-anlytics-main">
                <AdminUpperNav />
                <div className="Admin-analytics-content justify-evenly gap-6 p-6    ">
                    <div className="userdetailsNsubscription flex gap-6 ">
                        {/* USERS DOUGHNUT */}
                        <div className="users_anlytics p-6 border-2 rounded-xl w-1/2 items-center h-120 flex flex-col justify-center shadow-xl">
                            <p className="font-semibold mb-4">Users Details</p>
                        ...
                        {/* SUBSCRIPTIONS BAR */}
                        <div className="subscription-anlytics p-6 border-2 rounded-xl w-1/2 items-center h-120 flex flex-col justify-center shadow-2xl">
                            <p className="font-semibold mb-4">Subscriptions Details</p>
                    ...
                    {/* Plans Lists */}
                    <div className="plans-list border-2 shadow-2xl rounded-2xl  ">
                        <h2 className='flex items-center justify-center text-2xl font-semibold mb-4 pt-2.5'>Plans Details</h2>
                        <div className="plans-wk flex flex-row items-center justify-evenly">
                        ...
                        <div className="plans flex flex-row gap-2 items-center justify-evenly">
